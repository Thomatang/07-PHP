...
echo "Today's date is (English): ".date("l j F Y")."<br>";
echo "La data di oggi è (Italiano): ".strftime("%A %d %B %Y");
...
echo "There were {$daysInFeb} days in February 2017.";

// Exercise7
echo "<h2>Exercise 7</h2><p>20 days from today, the date will be:</br>";
$date = date("d-m-Y");
